...
Este documento descreve a compilação e a gravação do bootloader **Katapult** para o microcontrolador **iHeater**. O Katapult permite atualizar o firmware Klipper por USB e também é usado durante a instalação do firmware **Klipper** no controlador **iHeater**.
...
!!! warning "Se não conseguir compilar e gravar o firmware diretamente na impressora"
...
Remova o jumper, mantenha o botão MODE pressionado, pressione e solte RESET ou reconecte o USB.
...
* O Katapult ocupa os primeiros 8 KB da Flash, portanto **no Klipper é obrigatório especificar o deslocamento de 8KiB**.
* É possível entrar no DFU com um duplo pressionamento de RESET ou pelo botão GPIO (PA4).
* PA13/PA14 são usados para SWD.
* Após gravar o Katapult, o programador ST-Link não é mais necessário; as atualizações seguintes podem ser feitas por USB.
...
**As etapas seguintes pressupõem que o bootloader Katapult já está instalado.**
...
`iHeater está pronto para funcionar com Klipper`
